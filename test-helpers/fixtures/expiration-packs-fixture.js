...
exports.remove_fixtures_expirationPacks = function(){
    return [
        {
            type: 'remove',
            table: 'industry'
...
exports.fixture_expirationPacks = function() {
    return [
        {
            type: 'insert',
            table: 'country',
        ...
        },
        {
            ...
            values: {
                ...
                city: 'North',
                zip_code: 'Fr3zz3',
                email_address: 'usertest1@test1.com',
        ...
        },
        {
            ...
            values: {
                ...
                city: 'North',
                zip_code: 'Fr3zz3',
                email_address: 'usertest2@test2.com',
                sha_password: "\\x" + sha512("phantom").toString('hex'),
                status: 1,
                country_code: 'ES'
            }
        ...
        },
        {
            ...
            values: {
                code: 'USA-S-2',
                region_code: 'USA',
                name: 'Estados Unidos Pack 2',
                product_type: 0,
                publication_date: '2014-07-04',
                scope_text: 'Estados Unidos Pack 2 text',
                pattern_type: 0,
                subname: ' '
            }
        },
        {
            ...
            values: {
                code: 'USA-S-3',
                region_code: 'USA',
                name: 'Estados Unidos Pack 3',
                product_type: 0,
                publication_date: '2014-07-04',
                scope_text: 'Estados Unidos Pack 3 text',
                pattern_type: 0,
                subname: ' '
            }
        },
