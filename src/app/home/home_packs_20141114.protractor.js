                ...
                describe("stocks tab", function() {
                    ...
                    describe("go to Estados Unidos Pack I catalog", function() {
                        ...
                        it("should navigate through pages", function() {
                            ...
                            catalog_page.getPaginatorPageNumber(5).click();
                            ptor.sleep(2000);
                            expect(catalog_page.getPatternName(0).getText()).toBe("Long name Asset 191");
                            expect(catalog_page.getPatternName(1).getText()).toBe("Long name Asset 192");
                            expect(catalog_page.getPatternName(2).getText()).toBe("Long name Asset 193");
                            expect(catalog_page.getPatternName(3).getText()).toBe("Long name Asset 194");
                            //page 3
                            catalog_page.getPaginatorPageNumber(3).click();
                            ptor.sleep(2000);
                            expect(catalog_page.getPatternName(0).getText()).toBe("Long name Asset 171");
                            expect(catalog_page.getPatternName(1).getText()).toBe("Long name Asset 172");
                            expect(catalog_page.getPatternName(2).getText()).toBe("Long name Asset 173");
                            expect(catalog_page.getPatternName(3).getText()).toBe("Long name Asset 174");
                        });
