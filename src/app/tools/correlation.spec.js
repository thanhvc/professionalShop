describe('The Correlation controller', function () {
    ...
    describe('template', function () {
        ...
        var patternFilters = '/patternfilters?indexType=0&market=&month=11&productType=0&token=1&view=&year=2014';
        var patternFilters1 = '/patternfilters?indexType=0&market=&month=11&productType=1&token=1&view=&year=2014';
        var patternFilters3 = '/patternfilters?indexType=0&market=&month=11&productType=3&token=1&view=&year=2014';
        var patternFiltersRegion3 = '/patternfilters?indexType=0&market=&month=11&productType=3&region=&token=1&view=&year=2014';
        var patternFiltersRegion = '/patternfilters?indexType=0&market=&month=11&productType=0&region=&token=1&view=&year=2014';
        var patternFiltersRegionUn = '/patternfilters?indexType=0&market=&month=11&productType=0&region=undefined&token=1&view=&year=2014';
        var correlationPatternsRegion1 = '/patternfilters?indexType=0&market=&month=11&productType=1&region=&token=1&view=&year=2014';
        var addCorrelation = '/correlationpatterns?add_delete=0&correlationList=1&favourites=&indexType=0&market=&month=11&name=&operation=&page=1&patternId=%7B%22patternType%22:%22STOCK%22,%22id%22:1%7D&productType=0&token=1&year=2014';
        var addCorrelationRegionUn = '/correlationpatterns?add_delete=0&correlationList=1&favourites=&indexType=0&market=&month=11&name=&operation=&page=1&patternId=%7B%22patternType%22:%22STOCK%22,%22id%22:1%7D&productType=0&region=undefined&token=1&year=2014';
        var deleteCorrelationRegionUn = '/correlationpatterns?add_delete=1&correlationList=1&favourites=&indexType=0&market=&month=11&name=&operation=&page=1&patternId=%7B%22patternType%22:%22STOCK%22,%22id%22:1%7D&productType=0&region=undefined&token=1&year=2014';

        var correlationPatternsRegion = '/correlationpatterns?favourites=&indexType=0&market=&month=11&name=&operation=&page=1&productType=0&region=&token=1&year=2014';
        var correlationPatterns = '/correlationpatterns?favourites=&indexType=0&market=&month=11&name=&operation=&page=1&productType=0&region=&token=1&year=2014';
        var correlationPatterns1 = '/correlationpatterns?favourites=&indexType=0&market=&month=11&name=&operation=&page=1&productType=1&region=&token=1&year=2014';
        var correlationPatterns2 = '/correlationpatterns?favourites=&indexType=0&market=&month=11&name=&operation=&page=1&productType=2&region=&token=1&year=2014';
        var correlationPatterns3 = '/correlationpatterns?favourites=&indexType=0&market=&month=11&name=&operation=&page=1&productType=3&region=&token=1&year=2014';
        var correlationPatternsList = '/correlationpatterns?correlationList=1&favourites=&indexType=0&market=&month=11&name=&operation=&page=1&productType=0&token=1&year=2014';
        var correlationPatternsRegionUn = '/correlationpatterns?correlationList=1&favourites=&indexType=0&market=&month=11&name=&operation=&page=1&productType=0&region=undefined&token=1&year=2014';
