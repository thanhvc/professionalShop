describe('The Correlation controller', function () {
    ...
    describe('template', function () {
        ...
        var patternFilters = '/patternfilters?indexType=0&market=&month=12&productType=0&view=&year=2014';
        var patternFilters1 = '/patternfilters?indexType=0&market=&month=12&productType=1&view=&year=2014';
        var patternFilters3 = '/patternfilters?indexType=0&market=&month=12&productType=3&view=&year=2014';
        var patternFiltersRegion3 = '/patternfilters?indexType=0&market=&month=12&productType=3&region=&view=&year=2014';
        var patternFiltersRegion = '/patternfilters?indexType=0&market=&month=12&productType=0&region=&view=&year=2014';
        var patternFiltersRegionUn = '/patternfilters?indexType=0&market=&month=12&productType=0&region=undefined&view=&year=2014';
        var correlationPatternsRegion1 = '/patternfilters?indexType=0&market=&month=12&productType=1&region=&view=&year=2014';
        var addCorrelation = '/correlationpatterns?add_delete=0&correlationList=1&favourites=&indexType=0&market=&month=12&name=&operation=&page=1&patternId=%7B%22patternType%22:%22STOCK%22,%22id%22:1%7D&productType=0&year=2014';
        var addCorrelationRegionUn = '/correlationpatterns?add_delete=0&correlationList=1&favourites=&indexType=0&market=&month=12&name=&operation=&page=1&patternId=%7B%22patternType%22:%22STOCK%22,%22id%22:1%7D&productType=0&region=undefined&year=2014';
        var deleteCorrelationRegionUn = '/correlationpatterns?add_delete=1&correlationList=1&favourites=&indexType=0&market=&month=12&name=&operation=&page=1&patternId=%7B%22patternType%22:%22STOCK%22,%22id%22:1%7D&productType=0&region=undefined&year=2014';

        var correlationPatternsRegion = '/correlationpatterns?favourites=&indexType=0&market=&month=12&name=&operation=&page=1&productType=0&region=&year=2014';
        var correlationPatterns = '/correlationpatterns?favourites=&indexType=0&market=&month=12&name=&operation=&page=1&productType=0&region=&year=2014';
        var correlationPatterns1 = '/correlationpatterns?favourites=&indexType=0&market=&month=12&name=&operation=&page=1&productType=1&region=&year=2014';
        var correlationPatterns2 = '/correlationpatterns?favourites=&indexType=0&market=&month=12&name=&operation=&page=1&productType=2&region=&year=2014';
        var correlationPatterns3 = '/correlationpatterns?favourites=&indexType=0&market=&month=12&name=&operation=&page=1&productType=3&region=&year=2014';
        var correlationPatternsList = '/correlationpatterns?correlationList=1&favourites=&indexType=0&market=&month=12&name=&operation=&page=1&productType=0&year=2014';
        var correlationPatternsRegionUn = '/correlationpatterns?correlationList=1&favourites=&indexType=0&market=&month=12&name=&operation=&page=1&productType=0&region=undefined&year=2014';
        var favourite = '/favoritepattern?patternId=1';
        var correlationPdf = '/correlationpdf?indexType=0&productType=0';
        var correlationPdf1 = '/correlationpdf?indexType=0&productType=1';
        var correlationPdf2 = '/correlationpdf?indexType=0&productType=2';
        var correlationPdf3 = '/correlationpdf?indexType=0&productType=3';
        var correlationResult = '/correlationresult?correlationList=1&indexType=0&productType=0';
