...
describe('The patterns controller', function() {
    var $scope, ctrl, state,$http,myPatternsData;
    beforeEach(angular.mock.module("ngMo"));
    beforeEach(angular.mock.module("ngMo.my_patterns"));
    beforeEach(angular.mock.module("auth"));
    beforeEach(angular.mock.module("ngMo.home"));
    //beforeEach(inject(function ($controller, $rootScope,_$http_, myPatternsData  ){ //, $state, $stateParams, $location, TabsService, ActualDateService, PatternsService, MonthSelectorService, IsLogged, myPatternsData, SelectedMonthService, ExpirationYearFromPatternName) {
    beforeEach(inject(function ($controller, $rootScope, $state ,ExpirationYearFromPatternName, TabsService){ //, $state, $stateParams, $location, TabsService, ActualDateService, PatternsService, MonthSelectorService, IsLogged, myPatternsData, SelectedMonthService, ExpirationYearFromPatternName) {
        ...
        $scope = $rootScope.$new();
        state = $state;
        myPatternsData = $state.myPatternsData;
        $controller('PatternsCtrl', {'$scope': $rootScope, 'state': $state, 'myPatternsData': myPatternsData, 'ExpirationYearFromPatternName': ExpirationYearFromPatternName, 'TabsService': TabsService}); //, 'ActualDateService': ActualDateService, 'IsLogged': IsLogged, 'ExpirationYearFromPatternName': ExpirationYearFromPatternName});
    }));
    ...
    it('should success on stateChangeStart', function(){
    ...
    it('should restartFilter', function(){
        ...
        $scope.filterOptions.selectos = {'months': ['Enero', 'Febrero']};
        $scope.restartFilter();
    ...
    it('should restore data', function() {
        ...
        expect($scope.restoreData()).toBe(false);
    ...
    it('should save url params', function(){
        $scope.filterOptions.filters = {'month': 'agosto',selectedRent: 'rent',selectedOperation: 'operation',selectedIndustry: 'industry', selectedSector: 'sector', selectedMarket: 'market', selectedRegion:' region', rentAverageInput: 12, 'favourite': '', 'filterName': 'name', 'durationInput': ''};
        $scope.saveUrlParams(1);
